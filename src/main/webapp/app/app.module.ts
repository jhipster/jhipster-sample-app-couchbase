...
import { JhipsterCouchbaseSampleApplicationCoreModule } from 'app/core';
...
import { JhipsterCouchbaseSampleApplicationAccountModule } from './account/account.module';
...
@NgModule({
  imports: [
    ...
    JhipsterCouchbaseSampleApplicationSharedModule.forRoot(),
    JhipsterCouchbaseSampleApplicationCoreModule,
    JhipsterCouchbaseSampleApplicationHomeModule,
    JhipsterCouchbaseSampleApplicationAccountModule,
